...
export const createWallet = async (): Promise<Wallet> => {
  ...
  const organizations = [
    ...
    { id: config.mspIdSecurityOrg, cert: config.certificateSecurityOrg, key: config.privateKeySecurityOrg },
    { id: config.mspIdIntegrityOrg, cert: config.certificateIntegrityOrg, key: config.privateKeyIntegrityOrg },
    { id: config.mspIdNetworkMobilityOrg, cert: config.certificateNetworkMobilityOrg, key: config.privateKeyNetworkMobilityOrg },
    { id: config.mspIdAvailabilitySensor, cert: config.certificateAvailabilitySensor, key: config.privateKeyAvailabilitySensor },
  ];
