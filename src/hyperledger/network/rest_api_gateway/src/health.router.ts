...
healthRouter.get('/live', async (req: Request, res: Response) => {
  ...
  try {
    ...
    const qsccContracts: Contract[] = [
      ...
      req.app.locals[config.mspIdSecurityOrg]?.qsccContract as Contract,
      req.app.locals[config.mspIdIntegrityOrg]?.qsccContract as Contract,
      req.app.locals[config.mspIdNetworkMobilityOrg]?.qsccContract as Contract,
      req.app.locals[config.mspIdAvailabilitySensor]?.qsccContract as Contract,
